...
const Header = () => {
  return (
    <div>
        <div className='px-5 md:px-10 py-3 flex justify-between items-center bg-white'>
            <div className='w-[150px]'>
            <img src="/images/resollect.png" className='hidden md:block' alt="" />
            </div>
            ...
            <div className='flex gap-2'>
                ...
                <div className='hidden md:block'>
                    <h1>Kartik</h1>
                    <p className='text-sm text-gray-500 '>Kartik@resollect.com</p>
                </div>
                <div className='flex items-center hover:bg-gray-200 hidden md:block'>
        ...
        <hr className='h-[1px] text-gray-300' />
